...
There are 1361 rows. A defect in a generator is in all of them at once, and it
arrives everywhere on the same commit. One heavily reviewed component beats
1361 lightly reviewed ones, but only if it is actually treated as one — so
...
1361 rows 1361 independent acts:
