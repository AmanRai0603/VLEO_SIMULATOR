...
There are 1373 rows. A defect in a generator is in all of them at once, and it
arrives everywhere on the same commit. One heavily reviewed component beats
1373 lightly reviewed ones, but only if it is actually treated as one — so
...
1373 rows 1373 independent acts:
