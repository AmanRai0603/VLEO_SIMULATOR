...
There are 1394 rows. A defect in a generator is in all of them at once, and it
arrives everywhere on the same commit. One heavily reviewed component beats
1394 lightly reviewed ones, but only if it is actually treated as one — so
...
1394 rows 1394 independent acts:
