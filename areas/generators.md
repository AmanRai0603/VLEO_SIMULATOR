...
There are 1393 rows. A defect in a generator is in all of them at once, and it
arrives everywhere on the same commit. One heavily reviewed component beats
1393 lightly reviewed ones, but only if it is actually treated as one — so
...
1393 rows 1393 independent acts:
