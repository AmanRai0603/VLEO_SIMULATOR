...
There are 1374 rows. A defect in a generator is in all of them at once, and it
arrives everywhere on the same commit. One heavily reviewed component beats
1374 lightly reviewed ones, but only if it is actually treated as one — so
...
1374 rows 1374 independent acts:
