...
/// What this node publishes: `theta_s` (Mean solar incidence angle on the array), in `deg`.
...
pub const OUTPUT_VARS: &[&str] = &["pwr_array_incidence"];
...
pub const OUTPUT_UNITS: &[Unit] = &[Angle::UNIT];
