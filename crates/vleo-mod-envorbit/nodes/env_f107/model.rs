...
/// Source: `noaa_swpc`
///
/// Shipped climatology stands in when no solar-drivers bundle is synced, and
/// the run is marked amber.
pub const NODE_ID: &str = "env_f107";
/// Hash of the sheet this file was generated from. A face carrying a
/// different one refuses to run rather than showing a stale page.
pub const SHEET_HASH: u64 = 0xbd502f9d11b27cc4;

pub fn evaluate() -> Result<Ratio, Fault> {
    // generated · a declared value, converted from the unit it was written in
    let declared: Ratio = match Ratio::from_unit(150.0, Unit::One) {
        Some(q) => q,
        None => return Err(Fault::Degenerate { node: NODE_ID, field: "F107", reason: "the declared unit does not match the declared type" }),
    };
