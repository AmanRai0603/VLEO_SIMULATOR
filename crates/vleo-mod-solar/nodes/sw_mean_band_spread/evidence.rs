...
//! Evidence for `sw_mean_band_spread`.
//!
...
///
/// Migrated from `prf_rebuild.m:404 (01_kernel/sw_study/03_analysis, R.sigma.total)`. A second opinion and never an expected
