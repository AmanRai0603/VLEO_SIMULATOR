...
//! Evidence for `sw_ap_mean_band_spread`.
//!
...
///
/// Migrated from `prf_rebuild.m:404 (01_kernel/sw_study/03_analysis, R.sigma.total for ap)`. A second opinion and never an expected
