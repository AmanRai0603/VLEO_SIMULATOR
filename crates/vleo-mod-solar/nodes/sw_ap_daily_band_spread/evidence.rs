...
///
/// Migrated from `prf_density.m:225 (01_kernel/sw_study/06_density, local function designWindow_, qHi for ap)`. A second opinion and never an expected
