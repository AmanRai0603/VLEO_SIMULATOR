...
| | |
|---|---|
| rows in the tree | 1391 across four layers — 317 written, 1074 seeded |
...
| of the 317 written | 132 declared values · 167 computed · 12 KPI closures · 1 requirement · 5 achieved |
...
| nodes past every machine check | 12 of 317, waiting on a person — see [Where it stands](#where-it-stands) |
...
— it will be paid 1391 times.

### The nine generators

Six run per node. Each reads that node's sheet and nothing else, which is what
makes 1391 rows 1391 independent pieces of work rather than one large one.
...
useful in. 317 rows of 1391 have content, and `xtask ready` reports 12 of those
317 past every machine stage and waiting on a person. It names what holds the
other 281:
