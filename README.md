...
| | |
|---|---|
| rows in the tree | 1362 across four layers — 269 written, 1093 seeded |
...
| of the 269 written | 114 declared values · 139 computed · 12 KPI closures · 1 requirement · 3 achieved |
...
useful in. 269 rows of 1362 have content. `xtask ready` reports what is holding
the rest:
