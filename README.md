...
| | |
|---|---|
| rows in the tree | 1368 across four layers — 290 written, 1078 seeded |
...
| of the 290 written | 127 declared values · 147 computed · 12 KPI closures · 1 requirement · 3 achieved |
...
— it will be paid 1368 times.

### The nine generators

Six run per node. Each reads that node's sheet and nothing else, which is what
makes 1368 rows 1368 independent pieces of work rather than one large one.
...
useful in. 290 rows of 1368 have content. `xtask ready` reports what is holding
the rest:
