...
| | |
|---|---|
| rows in the tree | 1386 across four layers — 309 written, 1077 seeded |
...
| of the 309 written | 134 declared values · 159 computed · 12 KPI closures · 1 requirement · 3 achieved |
...
| nodes past every machine check | 12 of 309, waiting on a person — see [Where it stands](#where-it-stands) |
...
— it will be paid 1386 times.

### The nine generators

Six run per node. Each reads that node's sheet and nothing else, which is what
makes 1386 rows 1386 independent pieces of work rather than one large one.
...
useful in. 309 rows of 1386 have content, and `xtask ready` reports 12 of those
309 past every machine stage and waiting on a person. It names what holds the
other 281:
