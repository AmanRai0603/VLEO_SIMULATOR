...
| | |
|---|---|
| rows in the tree | 1382 across four layers — 305 written, 1077 seeded |
...
| of the 305 written | 134 declared values · 155 computed · 12 KPI closures · 1 requirement · 3 achieved |
...
| nodes past every machine check | 12 of 305, waiting on a person — see [Where it stands](#where-it-stands) |
...
— it will be paid 1382 times.

### The nine generators

Six run per node. Each reads that node's sheet and nothing else, which is what
makes 1382 rows 1382 independent pieces of work rather than one large one.
...
useful in. 305 rows of 1382 have content, and `xtask ready` reports 12 of those
305 past every machine stage and waiting on a person. It names what holds the
other 281:
