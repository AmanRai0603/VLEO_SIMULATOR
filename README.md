...
| | |
|---|---|
| rows in the tree | 1395 across four layers — 319 written, 1076 seeded |
...
— it will be paid 1395 times.

### The nine generators

Six run per node. Each reads that node's sheet and nothing else, which is what
makes 1395 rows 1395 independent pieces of work rather than one large one.
...
useful in. 319 rows of 1395 have content, and `xtask ready` reports 12 of those
