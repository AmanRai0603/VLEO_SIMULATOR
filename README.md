...
| | |
|---|---|
| rows in the tree | 1380 across four layers — 293 written, 1078 seeded |
...
— it will be paid 1380 times.

### The nine generators

Six run per node. Each reads that node's sheet and nothing else, which is what
makes 1380 rows 1380 independent pieces of work rather than one large one.
...
useful in. 293 rows of 1380 have content, and `xtask ready` reports 12 of those
